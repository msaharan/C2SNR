...
# To store the data
###############################################################################
d_file = open("./Text_files/test_d.txt", 'w')
z_file = open("./Text_files/test_z.txt", 'w')
#------------------------------------------------------------------------------
...
L , d_CL = np.loadtxt('./Text_files/test_d.txt', unpack = True)
L , z_CL = np.loadtxt('./Text_files/test_z.txt', unpack = True)

#plt.plot(L, d_CL, color='red', label='This work (integ. over dist.)', marker = 'o')
