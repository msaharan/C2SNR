...
# To store the data
###############################################################################
d_file = open("./Text_files/test_5_linear_distance.txt", 'w')
z_file = open("./Text_files/test_5_linear_redshift.txt", 'w')

d_file_nl = open("./Text_files/test_5_nonlinear_distance.txt", 'w')
z_file_nl = open("./Text_files/test_5_nonlinear_redshift.txt", 'w')
#------------------------------------------------------------------------------
...
L , d_CL = np.loadtxt('./Text_files/test_5_linear_distance.txt', unpack = True)
L , z_CL = np.loadtxt('./Text_files/test_5_linear_redshift.txt', unpack = True)

L_nl , d_CL_nl = np.loadtxt('./Text_files/test_5_nonlinear_distance.txt', unpack = True)
L_nl , z_CL_nl = np.loadtxt('./Text_files/test_5_nonlinear_redshift.txt', unpack = True)
