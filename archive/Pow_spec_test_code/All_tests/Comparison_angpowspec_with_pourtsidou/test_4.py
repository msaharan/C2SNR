...
PK = get_matter_power_interpolator(pars, nonlinear=False, kmax = 1, k_hunit = False, hubble_units = True)
...
k = 10**np.linspace(-6,1,1000) 
PK_nl = get_matter_power_interpolator(pars_nl, nonlinear=True, kmax = 1, k_hunit = False, hubble_units = True)
