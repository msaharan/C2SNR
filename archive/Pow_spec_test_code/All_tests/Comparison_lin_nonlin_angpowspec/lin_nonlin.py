...
# To store the data
###############################################################################
l_file = open("./Text_files/lin.txt", 'w')
nl_file = open("./Text_files/nonlin.txt", 'w')
#------------------------------------------------------------------------------
...
L_nl , CL_nl = np.loadtxt('./Text_files/nonlin.txt', unpack = True)
L , CL = np.loadtxt('./Text_files/lin.txt', unpack = True)
...
plt.legend()
#plt.ylim(1E-10,1E-7)
plt.savefig("./Plots/lin_nonlin.pdf")
plt.show()
#------------------------------------------------------------------------------
