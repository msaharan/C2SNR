...
def dblintegration(i):
    return integrate.dblquad(lambda l1,l2: dblintegrand(i,l1,l2),0 ,14000, lambda l2: 0,lambda l2:14000)[0]
...
fileout = open("integration_with_error_plot_without_k_sum_l_upto_14000.txt", "a")
...
plt.ylim(1E-9,1E-7)
plt.xlim(10,1000)
plt.savefig("integration_with_error_plot_without_k_sum_l_upto_14000.pdf")
plt.show()
