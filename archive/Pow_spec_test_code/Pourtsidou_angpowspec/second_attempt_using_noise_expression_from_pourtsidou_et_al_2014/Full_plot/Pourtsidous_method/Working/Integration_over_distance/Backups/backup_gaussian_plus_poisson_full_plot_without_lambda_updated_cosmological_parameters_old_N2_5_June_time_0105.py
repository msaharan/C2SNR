...
fileout = open("./J_text_files/gaussian_plus_poisson_error_bar_integration_over_distance_updated_cosmological_parameters_j_upp_limit_{}_lmax_{}.txt".format(j_upp_limit-1, l_max), "w")
...
plt.legend()
plt.ylim(1E-9,1E-7)
plt.savefig("./J_plots/gaussian_plus_poisson_full_plot_integration_over_distance_updated_cosmological_parameters_j_upp_limit_{}_lmax_{}.pdf".format(j_upp_limit - 1, l_max))
plt.show()
#-----------------------------------------------------------------------------------------
