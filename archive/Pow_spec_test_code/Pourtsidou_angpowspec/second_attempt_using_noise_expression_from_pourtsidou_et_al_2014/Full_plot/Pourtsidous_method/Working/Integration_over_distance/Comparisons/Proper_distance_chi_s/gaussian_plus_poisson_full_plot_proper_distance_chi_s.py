...
####################################################
## Angular diameter distance between z = 0 to some redshift
##################################################
...
# Angular diameter distance between z = 0 and z = source redshift
...
"""
fileout = open("./J_text_files/gaussian_plus_poisson_error_bar_integration_over_distance_proper_distance_chi_s_j_upp_limit_{}_lmax_{}.txt".format(j_upp_limit-1, l_max), "w")
...
fileout.close()
"""
plt.plot(L_array[l_plot_low_limit:l_plot_upp_limit], 10 * angpowspec_without_j_signal_in_final_plot[l_plot_low_limit:l_plot_upp_limit], color='blue', label='This work (z = {}) $\times 10$'.format(redshift))
plt.xlabel('L')
...
plt.legend()
#plt.ylim(1E-9,1E-7)
plt.savefig("./J_plots/gaussian_plus_poisson_full_plot_integration_over_distance_proper_distance_chi_s_power_multiplied_by_10_j_upp_limit_{}_lmax_{}.pdf".format(j_upp_limit - 1, l_max))
plt.show()
#-----------------------------------------------------------------------------------------
