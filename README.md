...
This file shows the general structure of the code to avoid the repetitive comments.
...
# Read more about camb.get_matter_power_interpolator at: https://camb.readthedocs.io/en/latest/camb.html?highlight=PK.P#camb.get_matter_power_interpolator
