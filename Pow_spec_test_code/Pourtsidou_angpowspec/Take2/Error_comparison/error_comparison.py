...
L_g_700, N_L_g_700 = np.loadtxt("../Gaussian/J_files/gaussian_integration_over_distance_j_upp_limit_1_lmax_700.txt", unpack=True)
L_g_10000, N_L_g_10000 = np.loadtxt("../Gaussian/J_files/gaussian_integration_over_distance_j_upp_limit_1_lmax_10000.txt", unpack=True)
...
plt.scatter(L_g_700, N_L_g_700, label = '(G, 700)', marker = 'o')
plt.scatter(L_g_10000, N_L_g_10000, label = '(G, 10000)', marker = '*')
plt.scatter(L_p_eta0, N_L_p_eta0, label = '(P, eta0)', marker = '+')
plt.scatter(L_p_eta2, N_L_p_eta2, label = '(P, eta2)', marker = 4)
plt.scatter(L_gp_700_eta0, N_L_gp_700_eta0, label = '(G+P, 700, eta0)', marker = 6)
plt.scatter(L_gp_10000_eta0, N_L_gp_10000_eta0, label = '(G+P, 10000, eta0)', marker = 9)
plt.legend()
