...
def angpowspec_integration_without_j(ell, redshift):
    ...
    return integrate.quad(angpowspec_integrand_without_j, 0.001, redshift, args = (ell, dist_s, constf))[0]
#------------------------------------------------------------------------------
...
plt.xlabel('L')
plt.ylabel(r'$C_{L} L(L+1)/2\pi \times 4\pi$')
...
plt.legend()
plt.ylim(1E-10,1E-7)
plt.savefig("./J_plots/angpowspec_only_with_offline_camb_non_linear_powspec_test.pdf")
plt.show()
