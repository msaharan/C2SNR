...
def dblintegration(i,k):
    return integrate.dblquad(lambda l1,l2: dblintegrand(i,k, l1, l2),0 ,i, lambda l2: 0,lambda l2:i)[0]
...
fileout = open("integration_with_error_plot_k_upto_2_l_upto_i.txt", "a")
...
plt.ylim(1E-9,1E-7)
plt.xlim(10,1000)
plt.savefig("integration_with_error_plot_k_upto_2_l_upto_i.pdf")
plt.show()
