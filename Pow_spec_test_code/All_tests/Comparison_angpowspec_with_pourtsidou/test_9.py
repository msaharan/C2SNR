...
PK = get_matter_power_interpolator(pars, nonlinear=False, kmax = 1, k_hunit = True, hubble_units = False)
...
k = 10**np.linspace(-6,1,1000)
PK_nl = get_matter_power_interpolator(pars_nl, nonlinear=True, kmax = 1, k_hunit = True, hubble_units = False)
#------------------------------------------------------------------------------

###############################################################################
# To store the data
###############################################################################
d_file = open("./Text_files/test_9_linear_distance.txt", 'w')
z_file = open("./Text_files/test_9_linear_redshift.txt", 'w')

d_file_nl = open("./Text_files/test_9_nonlinear_distance.txt", 'w')
z_file_nl = open("./Text_files/test_9_nonlinear_redshift.txt", 'w')
#------------------------------------------------------------------------------
...
L , d_CL = np.loadtxt('./Text_files/test_9_linear_distance.txt', unpack = True)
L , z_CL = np.loadtxt('./Text_files/test_9_linear_redshift.txt', unpack = True)

L_nl , d_CL_nl = np.loadtxt('./Text_files/test_9_nonlinear_distance.txt', unpack = True)
L_nl , z_CL_nl = np.loadtxt('./Text_files/test_9_nonlinear_redshift.txt', unpack = True)
