...
PK21 = get_matter_power_interpolator(pars21, nonlinear=True, kmax = 2)
...
# To store the data
###############################################################################
z_file_21 = open("./Text_files/angpowspec_integration_over_z_with_21.txt", 'w')
z_file = open("./Text_files/angpowspec_integration_over_z_without_21.txt", 'w')
#------------------------------------------------------------------------------
...
L , z_CL = np.loadtxt('./Text_files/angpowspec_integration_over_z_without_21.txt', unpack = True)
L , z_CL_21 = np.loadtxt('./Text_files/angpowspec_integration_over_z_with_21.txt', unpack = True)
...
plt.legend()
#plt.ylim(1E-10,1E-7)
plt.savefig("./Plots/angpowspec_comparison_with_without_21.pdf")
plt.show()
#------------------------------------------------------------------------------
