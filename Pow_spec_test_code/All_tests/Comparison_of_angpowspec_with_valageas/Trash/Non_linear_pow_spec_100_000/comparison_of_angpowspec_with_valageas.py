...
PK = get_matter_power_interpolator(pars, nonlinear=False, kmax = 60, k_hunit = False, hubble_units = False)
#------------------------------------------------------------------------------
...
# Plot from Valageas
x, y= np.loadtxt("/home/dyskun/Documents/Utility/Academics/Cosmology_project/C2SNR/Pow_spec_test_code/Data_files/Valageas/nonlinear_z_1.txt", unpack = True)
#------------------------------------------------------------------------------
...
plt.plot(x, y, label = "Valageas et al.")
plt.xlabel('L')
plt.ylabel(r'$2 \pi \; L^2\; C_{L}$')
plt.suptitle("Non-linear APS at z = 1")
plt.xscale("log")
plt.yscale("log")
