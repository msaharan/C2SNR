...
def angpowspec_integration_with_j(ell, j): 
    return integrate.quad(lambda x: angpowspec_integrand_with_j(ell, j, x), 0, chi_s[redshift])[0]
#----------------------------------------------------------
...
fileout = open("./J_text_files/gaussian_plus_poisson_error_bar_integration_over_distance_j_upp_limit_{}_lmax_{}_trial_before_corrections.txt".format(j_upp_limit-1, l_max), "w")
...
plt.legend()
plt.ylim(1E-9,1E-7)
plt.savefig("./J_plots/gaussian_plus_poisson_full_plot_integration_over_distance_j_upp_limit_{}_lmax_{}_trial_before_corrections.pdf".format(j_upp_limit - 1, l_max))
plt.show()
#-----------------------------------------------------------------------------------------
