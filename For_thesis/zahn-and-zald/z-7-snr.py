...
tz, k = np.loadtxt('/home/dyskun/Documents/Utility/Git/Msaharan/C2SNR/C2/data-files/tz_z7_fine.txt', unpack = True)
"""
...
plt.savefig('./plots/z_{}_snr_j_upp_limit_{}_lmax_{}.pdf'.format(redshift, j_upp_limit - 1, l_max))
plt.show()
