...
%& & \times \left[\pul_{l,k} \hat{\Psi}(\L)\L\cdot\l + \pul_{L-l,k}  \hat{\Psi}(\L)\L\cdot(\L-\l)\right] \, ,
%\eeqal
%\eeq
%
...
%\beq
%\beqal
%N_L^{\hat{\Psi}} = \frac{2 D_C}{2\pi \delta(0)} \frac{1}{{\int \frac{d^2 l}{(2\pi)^2} \sum_{k_1} \frac{[\pul_{l,k_1} \L\cdot \l +
%			\pul_{L-l,-k_1} \L\cdot (\L-\l)]^2}{\ptot_{l,k_1}\ptot_{L-l,-k_1}} }}
%\eeqal
%\eeq
